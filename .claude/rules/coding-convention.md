...
| # | Module | Topics |
|---|--------|--------|
| 1 | [Core Principles](./references/01-core-principles.md) | YAGNI, KISS, DRY, SOLID |
| 2 | [Naming & Constants](./references/02-naming-and-constants.md) | Naming conventions, magic values, consistency |
| 3 | [Function Design](./references/03-function-design.md) | Size, parameters, utils, types, return values |
| 4 | [Error Handling](./references/04-error-handling.md) | Errors, logging, security |
| 5 | [Testing](./references/05-testing.md) | Test pyramid, best practices, naming |
| 6 | [Code Quality](./references/06-code-quality.md) | Documentation, formatting, code review |
| 7 | [Architecture](./references/07-architecture.md) | Organization, dependencies, module boundaries |
| 8 | [Performance & Security](./references/08-performance-security.md) | Optimization, OWASP, secure coding |
