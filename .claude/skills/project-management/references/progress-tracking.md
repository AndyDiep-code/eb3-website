...
1. **Read plans directory:** Glob `.claude/tasks/*/plan/plan.md` to discover all plans (or use `$DEVKIT_ACTIVE_PLAN`)
...
Edit `plan.md` directly — only change the Status column cell, preserve table structure exactly.
