...
user-invocable: true
when_to_use: "Invoke for Node.js or TypeScript architecture, patterns, or stack recommendations."
category: backend
keywords: [nodejs, typescript, patterns, express, nestjs, server]
---

# NodeJS Specialist - Backend Generator
