...
user-invocable: true
when_to_use: "Invoke to create architecture, flowchart, or technical diagrams as standalone HTML."
license: MIT
metadata:
  version: "1.0"
category: frontend
keywords: [diagram, svg, architecture, flowchart, visualization, html]
---
