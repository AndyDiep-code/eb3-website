...
user-invocable: true
when_to_use: "Invoke to create, inspect, or clean isolated git worktrees for parallel development."
category: dev-tools
...
**Typically precedes:** `/devkit:cook` (implement in worktree), `/devkit:fix` (fix in worktree)
