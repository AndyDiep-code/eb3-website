...
2. **Research** — Activate `/docs-seeker`, `/devkit:research` for best practices
...
6. Launch viewer: `scripts/generate_report.py` → interactive HTML review
...
| `scripts/generate_report.py` | Generate interactive HTML eval viewer |
