...
2. Activate `devkit:debug` skill (systematic-debugging + root-cause-tracing).
...
Activate `devkit:brainstorm` skill.
...
| 2 | `devkit:debug`, `sequential-thinking`, parallel `Explore`, (`problem-solving` auto) |
| 3 | `researcher` (runs parallel with steps 1+2) |
| 4 | `devkit:brainstorm` |
| 5 | `planner` |
| 6 | `problem-solving`, `sequential-thinking` |
| 7 | `tester`, parallel `Bash` verification |
| 8 | `code-reviewer` |
| 9 | `project-management`, `docs-manager` |

**Rules:** Don't skip steps. Validate before proceeding. One phase at a time.
**Frontend:** Use `devkit:agent-browser`, `devkit:chrome-profile`, Chrome MCP / `chrome-devtools-mcp`, or any relevant project-native browser tests to verify.
