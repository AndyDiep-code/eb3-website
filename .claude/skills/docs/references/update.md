<!--
Usage: /devkit:docs --mode update [additional-requests]
Example: /devkit:docs --mode update
Example: /devkit:docs --mode update "focus on API changes"
-->
...
3. Use `/scout "explore codebase for [topic]"` to explore the code base and return detailed summary reports to the main agent
...
1. Run: `node .claude/skills/docs/scripts/validate-docs.cjs docs/`
