...
- Scan `.claude/tasks/*/plan/plan.md` for active plans (or use `$DEVKIT_ACTIVE_PLAN`)
...
- `devkit:plan` — Creates implementation plans (planning phase)
- `devkit:cook` — Implements plans (execution phase, invokes project-manager at finalize)
