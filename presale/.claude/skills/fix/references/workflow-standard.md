...
2. Activate `devkit:debug` skill. Use `debugger` subagent if needed.
...
| 2 | `devkit:debug`, `sequential-thinking`, `debugger` subagent, parallel `Explore`, (`problem-solving` auto) |
...
| 6 | `project-management`, `docs-manager` subagents |
