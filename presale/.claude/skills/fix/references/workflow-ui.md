...
Analyze screenshots/videos using native vision.
...
Screenshot + native vision analysis.
...
Use `devkit:agent-browser`, `devkit:chrome-profile`, Chrome MCP / `chrome-devtools-mcp`, or project-native browser tests.
