...
Activate `devkit:debug` skill. Activate `sequential-thinking` for structured analysis.
...
| 2 | `devkit:debug`, `sequential-thinking` |
| 3 | Parallel `Bash` for verification |
| 4 | `code-reviewer` subagent |
| 5 | Report |
| 6 | `project-management` (MANDATORY), `docs-manager` |
