...
File globs to use: {FILE_GLOBS}  ← use ONLY these; do NOT default to *.{ts,tsx,js,jsx,json} unless stack is JS/TS

Instructions:
- Search for relevant files using the provided file globs above
