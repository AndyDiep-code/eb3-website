...
when_to_use: "Invoke for OSINT, threat intelligence, or cyber investigation tasks."
category: security
...
metadata:
  ...
  source: "https://github.com/7onez/cyber-threat-expert"
  license: "MIT"
---
...
python3 ~/.claude/skills/cyber-threat-expert/scripts/generate-cti-docx-hybrid.py \
...
python3 ~/.claude/skills/cyber-threat-expert/scripts/generate-cti-docx.py \
  "CTI-REPORT-[CASE-ID]-[YYYY-MM-DD].json" \
  "CTI-REPORT-[CASE-ID]-[YYYY-MM-DD].docx"
...
Activate for session: `/cyber-threat-expert --yolo`
