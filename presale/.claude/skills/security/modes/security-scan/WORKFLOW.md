...
```
/devkit:security --mode security-scan              # Full scan of current project
/devkit:security --mode security-scan --secrets-only   # Only secret/credential detection
/devkit:security --mode security-scan --deps-only      # Only dependency audit
/devkit:security --mode security-scan src/api/         # Scan specific directory
```
