...
- **Technical Documents** (`./docs/technical-documents.md`): Detailed record of all significant changes, features, and fixes
...
### Task Location
Save tasks in `./.claude/tasks/[TASK-ID]/` directory with timestamp and descriptive name.

**Format:** `./.claude/tasks/[TASK-ID]/`

**Example:** `./.claude/tasks/ABC-123/`
