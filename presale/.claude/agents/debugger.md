...
**IMPORTANT**: Always follow the development rules in `./.claude/docs/development-rules.md` (Project specific) and `./.claude/rules/coding-convention.md` (General development rules) in ALL circumstances. This is NON-NEGOTIABLE.
...
2. **Data Collection**
   ...
   - **When you need to understand the project structure:** 
     ...
     - **IMPORTANT**: ONLY process this following step `codebase-summary.md` doesn't contain what you need: use `/scout "prompt"` slash command to search the codebase for files needed to complete the task
