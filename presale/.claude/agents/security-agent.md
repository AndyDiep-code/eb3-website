...
- code-review (for systematic security vulnerability assessment in code)
- backend-development (for understanding secure API design and authentication patterns)
- research (for staying current with OWASP guidelines and security best practices)
