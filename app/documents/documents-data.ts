/**
 * Document checklist data ported verbatim from js/document-checklist-data.js
 * (the legacy `DOC_STAGES` array). That file is left untouched per the
 * migration plan — this module is the React/TypeScript-typed equivalent
 * consumed by documents-content.tsx.
 */
...
export const DOC_STAGES: ChecklistStage[] = [
  {
    id: "perm",
    cls: "w1",
    icon: "📝",
