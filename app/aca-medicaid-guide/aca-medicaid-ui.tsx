// Shared presentational primitives for ACA & Medicaid guide tab content —
// extracted so each tab file (aca-tab-*.tsx) only contains content, not
// repeated markup. Mirrors app/ac21-portability/ac21-ui.tsx.
